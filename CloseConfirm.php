...
class CloseConfirm extends Module
{
    protected $config_form = false;

    public function __construct()
    {
        $this->name = 'close_confirm';
        ...
        $this->displayName = $this->l('Exitpopup');
        $this->description = $this->l('Exitpopup desc lorem ipsum');
    ...
    {
        Configuration::updateValue('EXITPOPUP_LIVE_MODE', false);
    ...
    {
        Configuration::deleteByName('EXITPOPUP_LIVE_MODE');
    ...
    public function getContent()
    {
         ...
         */
        if (((bool)Tools::isSubmit('submitExitpopupModule')) == true) {
            $this->postProcess();
        }
    ...
    protected function renderForm()
    {
        ...
        $helper->submit_action = 'submitExitpopupModule';
